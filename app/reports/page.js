                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
                            <thead style={{ background: 'rgba(255,255,255,0.05)', textAlign: 'left', borderBottom: '1px solid var(--card-border)' }}>
                                <tr>
                                    ...
                                    <th style={{ padding: '0.75rem 1rem', borderRight: '1px solid var(--card-border)', color: 'var(--text-muted)', fontSize: '0.75rem', textTransform: 'uppercase', width: '100px', textAlign: 'right' }}>Est. Hours</th>
                                    <th style={{ padding: '0.75rem 1rem', borderRight: '1px solid var(--card-border)', color: 'var(--text-muted)', fontSize: '0.75rem', textTransform: 'uppercase', width: '100px', textAlign: 'right' }}>Used Hours</th>
                                    ...
                                    return (
                                        <Fragment key={job.id}>
                                            ...
                                            <tr style={{ borderBottom: '1px solid var(--card-border)', background: 'rgba(255,255,255,0.06)', fontWeight: 'bold' }}>
                                                ...
                                                <td style={{ padding: '0.75rem 1rem', borderRight: '1px solid var(--card-border)', verticalAlign: 'middle', textAlign: 'right', color: 'var(--foreground)' }}>
                                                ...
                                                <td style={{ padding: '0.75rem 1rem', borderRight: '1px solid var(--card-border)', verticalAlign: 'middle', textAlign: 'center', color: 'var(--foreground)' }}>
                                                    {jobComp}%
                                                </td>
                                                <td style={{ padding: '0.75rem 1rem', verticalAlign: 'middle', color: 'var(--text-muted)' }}>
                                                    -
                                                </td>
                                            </tr>
