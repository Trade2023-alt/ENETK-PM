...
def create_vba_excel():
    """Create Excel file with VBA macros"""
    ...
    instructions = [
        ...
        '3. Click "GENERATE QUOTE" button to create a new worksheet',
        '4. The new worksheet will contain your formatted quote',
    ...
    wb.save('Quote_Generator_VBA.xlsx')
    print("Excel workbook created: Quote_Generator_VBA.xlsx")
    
    # Now add VBA code
    add_vba_to_excel('Quote_Generator_VBA.xlsx')
...
End Sub'''
    ...
    # Save VBA code to a text file for manual copying
    with open('VBA_Code.txt', 'w') as f:
        f.write(vba_code)
    
    print("VBA code saved to: VBA_Code.txt")
    print("\nTo add VBA macros to your Excel file:")
    print("1. Open Quote_Generator_VBA.xlsx in Excel")
    print("2. Press Alt+F11 to open VBA Editor")
    print("3. Right-click on 'VBAProject (Quote_Generator_VBA.xlsx)'")
    print("4. Select 'Insert' > 'Module'")
    print("5. Copy the code from VBA_Code.txt and paste it into the module")
    print("6. Save the file and close VBA Editor")
    print("7. You can now use the buttons in the Excel file!")
