#!/usr/bin/env python3
"""
Create Working Excel with Proper VBA
Creates a working Excel file with proper VBA button connections
"""
...
def create_working_excel():
    """Create Excel file with working VBA and button connections"""
    ...
    # Header
    ws['A1'] = 'QUOTE GENERATOR - WORKING VERSION'
    ...
    # Save the workbook
    wb.save('Quote_Generator_Working.xlsx')
    print("Working Excel workbook created: Quote_Generator_Working.xlsx")
    
    # Create VBA code file for manual addition
    create_vba_code_file()

def create_vba_code_file():
    """Create VBA code file for manual addition"""
...
End Sub'''
    ...
    with open('Working_VBA_Code.txt', 'w') as f:
        f.write(vba_code)
    
    print("VBA code saved to: Working_VBA_Code.txt")
    print("\nTo make the buttons work:")
    print("1. Open Quote_Generator_Working.xlsx in Excel")
    print("2. Press Alt+F11 to open VBA Editor")
    print("3. Right-click on 'VBAProject' → Insert → Module")
    print("4. Copy the code from Working_VBA_Code.txt and paste it")
    print("5. Save the file and close VBA Editor")
    print("6. The buttons will now work!")

if __name__ == "__main__":
    create_working_excel()
